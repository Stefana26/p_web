...
public interface IAuthorService
{
    ...
    Task<ServiceResponse> AddAuthor(AuthorAddDTO author,UserDTO? requestingUser = default, CancellationToken cancellationToken = default);
    Task<ServiceResponse> UpdateAuthor(AuthorUpdateDTO author, CancellationToken cancellationToken = default);
