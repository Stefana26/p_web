...
import { ApiBookGetPageGetRequest, BookAddDTO, BookApi, BookUpdateDTO } from "../client";
...
export const useBookApi = () => {
    ...
    const getBooks = (page: ApiBookGetPageGetRequest) => new BookApi(config).apiBookGetPageGet(page); // Use the generated client code and adapt
